# Generated by Django 4.1.4 on 2022-12-12 11:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='certificate',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueitem', to='warehouse_app.certificate', verbose_name='Certyfikat'),
        ),
        migrations.AddField(
            model_name='issueitem',
            name='dimension',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueitem', to='warehouse_app.dimension', verbose_name='Średnica'),
        ),
        migrations.AddField(
            model_name='issueitem',
            name='grade',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueitem', to='warehouse_app.grade', verbose_name='Gatunek'),
        ),
        migrations.AddField(
            model_name='issueitem',
            name='heat',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueitem', to='warehouse_app.heat', verbose_name='Wytop'),
        ),
        migrations.AddField(
            model_name='issueitem',
            name='issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueitem', to='warehouse_app.issue', verbose_name='Rozchód'),
        ),
        migrations.AddField(
            model_name='issueitem',
            name='supply_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issueitem', to='warehouse_app.supplyitem', verbose_name='Dostawa'),
        ),
        migrations.AddIndex(
            model_name='issue',
